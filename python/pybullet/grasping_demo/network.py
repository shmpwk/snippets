...
class Encoder6to14(nn.Module):
    def __init__(self):
        super(Encoder6to14, self).__init__()
        self.conv1 = nn.Conv2d(6, 16, 3, 2, 1)
        self.cbn1 = nn.BatchNorm2d(16)
        self.conv2 = nn.Conv2d(16, 32, 3, 2, 1)
        self.cbn2 = nn.BatchNorm2d(32)
...
class ImgRobotEncoder(nn.Module):
    def __init__(self):
        super(ImgRobotEncoder, self).__init__()
        self.conv1 = nn.Conv2d(6, 16, 3, 2, 1)
        self.cbn1 = nn.BatchNorm2d(16)
        self.conv2 = nn.Conv2d(16, 32, 3, 2, 1)
        self.cbn2 = nn.BatchNorm2d(32)
